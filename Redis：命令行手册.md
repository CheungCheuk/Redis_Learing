...
INCR key|增加键的整数值一次|网页命中次数
INCRBY key increment|由给定的数量递增键的整数值|网页命中次数
INCRBYFLOAT key increment|       由给定的数量递增键的浮点值
DECR key|递减键一次的整数值|网页命中次数
DECRBY key decrement|由给定数目递减键的整数值|网页命中次数
...
ZRANGEBYSCORE key min max [WITHSCORES] [LIMIT] |返回有序集key中，所有 score 值介于 min 和 max 之间<br/>(包括等于 min 或 max )的成员，<br/>有序集成员按 score 值递增<br/>(从小到大)次序排列
